...
class Rectangle extends Shapes {
    ...
    createRectangle(textColor, shapeColor, text) {
        ...
        <text x="65" y="70" font-size="50" text-anchor="middle" dominant-baseline="middle"  fill="${textColor}">${text}</text>
...
class Triangle extends Shapes {
    ...
    createTriangle(textColor, shapeColor, text) {
        ...
        <text x="150" y="155" font-size="60" text-anchor="middle" fill="${textColor}">${text}</text>
